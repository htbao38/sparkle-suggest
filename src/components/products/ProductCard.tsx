  ...
  return (
    <div className="group card-elegant">
      ...
      <div className="relative img-zoom">
        ...
        {/* Add to cart overlay */}
        <div className="absolute bottom-0 left-0 right-0 p-4 bg-gradient-to-t from-black/60 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 z-10 pointer-events-none group-hover:pointer-events-auto">
          <Button
